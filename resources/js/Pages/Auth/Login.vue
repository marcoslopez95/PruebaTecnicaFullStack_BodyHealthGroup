        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">{{  $t('views.login.sign-in-chipset') }}</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
                ...
                <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        ...
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                <label class="mb-2.5 block font-medium text-black dark:text-white">{{ $t('views.login.email') }}</label>
                                <div class="relative">
                                    <input type="email" v-model="form.email" :placeholder="$t('views.login.placeholder.email')"
                            ...
                            <div class="mb-6">
                                <label class="mb-2.5 block font-medium text-black dark:text-white">{{ $t('views.login.password') }}</label>
                                <div class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" v-model="form.password" :placeholder="$t('views.login.placeholder.password')"
                                        class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                            ...
                            <div class="mb-5">
                                <button type="submit"
                                    ...
                                    <span v-else>{{$t('views.login.button')}}</span>
                                </button>
                            </div>
